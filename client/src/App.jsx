...
import { GET_USERS, VIEW_USERS, DELETE_USER, EDIT_USER, ADD_USER } from "./queries";
...
function App() {
  ...
  const editMutation = useMutation(EDIT_USER, { variables: { id: 9, name: "Username", email: "email", job_title: "job" }});
  const createMutation = useMutation(ADD_USER, { variables: { name: "Username", email: "email", job_title: "job" }});
